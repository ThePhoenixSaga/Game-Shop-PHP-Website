...
--
-- Host: localhost
-- Generation Time: Dec 16, 2017 at 10:07 AM
...
--
-- Database: `DataAnalysisAssignment2`
--
CREATE DATABASE IF NOT EXISTS `DataAnalysisAssignment2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `DataAnalysisAssignment2`;
...
CREATE TABLE IF NOT EXISTS `J_type` (
  `j_type_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `J_type` (`j_type_id`, `j_type`) VALUES
(1, 'Revenue'),
(2, 'Empty stock');
...
CREATE TABLE IF NOT EXISTS `Journey` (
  ...
  `journey` int(2) NOT NULL,
  `j_date` date NOT NULL,
  `j_service_name` varchar(255) NOT NULL,
  `j_type_id` int(11) NOT NULL,
  `unit_id` int(11) NOT NULL,
  PRIMARY KEY (`journey_id`),
  KEY `j_type_id` (`j_type_id`,`unit_id`),
  KEY `unit_id` (`unit_id`),
  KEY `j_type_id_2` (`j_type_id`)
...
INSERT INTO `Journey` (`journey_id`, `journey`, `j_date`, `j_service_name`, `j_type_id`, `unit_id`) VALUES
(1, 27, '2013-10-17', 'Alton Towers Express', 1, 5),
(2, 27, '2013-10-17', 'Alton Towers Express', 1, 5),
(3, 27, '2013-10-17', 'Alton Towers Express', 1, 5),
(4, 28, '2013-10-17', 'Alton Towers Express', 1, 5),
(5, 28, '2013-10-17', 'Alton Towers Express', 1, 5),
(6, 28, '2013-10-17', 'Alton Towers Express', 1, 5),
(7, 36, '2013-10-22', 'Local', 1, 1),
(8, 36, '2013-10-22', 'Local', 1, 1),
(9, 36, '2013-10-22', 'Local', 1, 1),
(10, 36, '2013-10-22', 'Local', 1, 1),
(11, 36, '2013-10-22', 'Local', 1, 1),
(12, 36, '2013-10-22', 'Local', 1, 1),
(13, 37, '2013-10-22', 'Local', 2, 1),
(14, 37, '2013-10-22', 'Local', 2, 1),
(16, 99, '0000-00-00', 'Local', 1, 1),
(24, 0, '2017-03-22', 'AltonTowersExpress', 1, 1),
(25, 88, '2017-03-27', 'Alton Towers Express', 2, 3);

-- --------------------------------------------------------

--
-- Table structure for table `Journey_station_link`
--

CREATE TABLE IF NOT EXISTS `Journey_station_link` (
  `journey_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`journey_id`),
  KEY `journey_id` (`journey_id`,`station_id`),
  KEY `station_id` (`station_id`),
  KEY `journey_id_2` (`journey_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=26 ;

--
-- Dumping data for table `Journey_station_link`
--

INSERT INTO `Journey_station_link` (`journey_id`, `station_id`, `arrive`, `depart`, `cost`) VALUES
(1, 15, '08:00:00', '08:10:00', 0.00),
(2, 19, '08:38:00', '08:40:00', 5.60),
(3, 24, '09:16:00', '09:22:00', 8.00),
(4, 24, '09:16:00', '09:22:00', 0.00),
(5, 19, '09:58:00', '10:00:00', 4.80),
(6, 15, '10:30:00', '10:40:00', 8.00),
(7, 15, '19:17:00', '19:24:00', 0.00),
(8, 16, '19:32:00', '19:34:00', 2.10),
(9, 17, '19:46:00', '19:48:00', 3.20),
(10, 18, '19:52:00', '19:54:00', 3.60),
(11, 19, '20:09:00', '20:11:00', 4.80),
(12, 19, '20:16:00', '20:20:00', 5.40),
(13, 19, '20:16:00', '20:20:00', 0.00),
(14, 20, '20:35:00', '00:00:00', 0.00),
(24, 15, '09:53:11', '10:23:11', 9.99),
(25, 21, '11:06:48', '11:36:48', 9.00);
...
INSERT INTO `Line` (`line_id`, `line`) VALUES
(1, 'MCR'),
(2, 'CVR');
...
CREATE TABLE IF NOT EXISTS `Station` (
  ...
  KEY `station_type_id` (`station_type_id`,`line_id`),
  KEY `station_type_id_2` (`station_type_id`),
  KEY `line_id` (`line_id`)
...
INSERT INTO `Station` (`station_id`, `station`, `station_type_id`, `line_id`) VALUES
(15, 'Stoke', 1, 1),
(16, 'Bucknall', 3, 1),
(17, 'Stockton Brook', 3, 1),
(18, 'Endon', 3, 1),
(19, 'Leekbrook', 2, 2),
(20, 'Cheddleton', 3, 2),
(21, 'Consall', 3, 2),
...
INSERT INTO `Station_type` (`station_type_id`, `station_type`) VALUES
(1, 'Mainline'),
(2, 'Interchange'),
(3, 'Timetabled'),
(4, 'Terminus');
...
INSERT INTO `Unit` (`unit_id`, `class`, `unit`) VALUES
(1, 153, 153381),
(2, 153, 153311),
(3, 153, 153302),
(4, 156, 156403),
...
--
ALTER TABLE `Journey`
  ADD CONSTRAINT `Journey_ibfk_1` FOREIGN KEY (`j_type_id`) REFERENCES `J_type` (`j_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Journey_ibfk_2` FOREIGN KEY (`unit_id`) REFERENCES `Unit` (`unit_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `Journey_station_link`
--
ALTER TABLE `Journey_station_link`
  ADD CONSTRAINT `Journey_station_link_ibfk_1` FOREIGN KEY (`journey_id`) REFERENCES `Journey` (`journey_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Journey_station_link_ibfk_2` FOREIGN KEY (`station_id`) REFERENCES `Station` (`station_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `Station`
--
ALTER TABLE `Station`
  ADD CONSTRAINT `Station_ibfk_1` FOREIGN KEY (`station_type_id`) REFERENCES `Station_type` (`station_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Station_ibfk_2` FOREIGN KEY (`line_id`) REFERENCES `Line` (`line_id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `DataAnalysisPractise`
--
CREATE DATABASE IF NOT EXISTS `DataAnalysisPractise` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `DataAnalysisPractise`;
...
CREATE TABLE IF NOT EXISTS `Sale` (
  ...
  `SaleTot` decimal(7,2) NOT NULL,
  `CrdAutNbr` int(11) DEFAULT NULL,
  `CustID` decimal(7,0) NOT NULL,
  PRIMARY KEY (`OrderID`)
...
--
-- Table structure for table `BookedGameLink`
--

CREATE TABLE IF NOT EXISTS `BookedGameLink` (
  `Booked_ID` int(11) NOT NULL AUTO_INCREMENT,
  `Game_ID` int(11) NOT NULL,
  PRIMARY KEY (`Booked_ID`),
  KEY `Booked_ID` (`Booked_ID`,`Game_ID`),
  KEY `Game_ID` (`Game_ID`)
...
--
-- Table structure for table `BookedGames`
--

CREATE TABLE IF NOT EXISTS `BookedGames` (
  `Booked_ID` int(11) NOT NULL AUTO_INCREMENT,
  `Game_ID` int(11) NOT NULL,
...
INSERT INTO `Games` (`Game_ID`, `desc`, `price`, `product_img`) VALUES
(1, '10 Second Ninja X', 13.99, 'prod_1'),
(2, '1979 Revolution: Black Friday', 14.99, 'prod_2'),
(3, 'A Boy and His Blob', 15.99, 'prod_3'),
(4, 'Attack on Titan', 18.99, 'prod_4'),
(5, 'BioShock: The Collection', 10.99, 'prod_5'),
(6, 'Conga Master', 9.99, 'prod_6'),
(7, 'Crazy Machines 3', 11.99, 'prod_7'),
(8, 'Doom', 15.99, 'prod_8'),
(9, 'Disgaea PC', 17.99, 'prod_9'),
(10, 'Final Fantasy IX', 14.99, 'prod_10');
...
INSERT INTO `UserAccounts` (`UserID`, `UserLevel`, `Username`, `Password`) VALUES
(1, 1, 'admin', 'password'),
(2, 2, 'user', '123password');

-- --------------------------------------------------------

--
-- Table structure for table `UserBookedLink`
--

CREATE TABLE IF NOT EXISTS `UserBookedLink` (
  `User_ID` int(11) NOT NULL,
  `Booked_ID` int(11) NOT NULL,
  KEY `User_ID` (`User_ID`,`Booked_ID`),
...
--
-- Constraints for table `BookedGameLink`
--
ALTER TABLE `BookedGameLink`
  ADD CONSTRAINT `BookedGameLink_ibfk_1` FOREIGN KEY (`Booked_ID`) REFERENCES `BookedGames` (`Booked_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `BookedGameLink_ibfk_2` FOREIGN KEY (`Game_ID`) REFERENCES `Games` (`Game_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `UserBookedLink`
--
ALTER TABLE `UserBookedLink`
  ADD CONSTRAINT `UserBookedLink_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `UserAccounts` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `UserBookedLink_ibfk_2` FOREIGN KEY (`Booked_ID`) REFERENCES `BookedGameLink` (`Booked_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `WebAppsAssignment2`
--
CREATE DATABASE IF NOT EXISTS `WebAppsAssignment2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `WebAppsAssignment2`;
...
INSERT INTO `booked_items` (`booked_id`, `user_id`, `item_id`, `booked_date`, `return_date`) VALUES
(3, 10, 15, '2017-01-13', '2017-01-27'),
(4, 10, 10, '2017-01-13', '2017-01-27'),
(5, 1, 1, '2017-01-13', '2017-01-27'),
(6, 17, 5, '2017-01-18', '2017-02-01'),
(7, 17, 7, '2017-01-18', '2017-02-01'),
(8, 17, 9, '2017-01-18', '2017-02-01'),
(9, 18, 2, '2017-01-18', '2017-02-01'),
(10, 23, 9, '2017-01-23', '2017-02-06'),
(11, 26, 3, '2017-01-23', '2017-02-06'),
(12, 27, 17, '2017-01-23', '2017-02-06'),
(13, 27, 16, '2017-01-23', '2017-02-06'),
(14, 28, 7, '2017-01-23', '2017-02-06'),
(15, 29, 1, '2017-01-23', '2017-02-06'),
(16, 29, 16, '2017-01-23', '2017-02-06'),
(17, 29, 4006, '2017-01-23', '2017-02-06'),
(18, 29, 4006, '2017-01-23', '2017-02-06'),
(19, 29, 8003, '2017-01-23', '2017-02-06'),
(20, 32, 2, '2017-01-23', '2017-02-06'),
(21, 32, 3, '2017-01-23', '2017-02-06'),
(22, 34, 7, '2017-01-23', '2017-02-06'),
(23, 35, 1, '2017-01-25', '2017-02-08'),
(24, 35, 2, '2017-01-25', '2017-02-08');

-- --------------------------------------------------------

--
-- Table structure for table `item_booked_link`
--

CREATE TABLE IF NOT EXISTS `item_booked_link` (
  `booked_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  KEY `booked_id` (`booked_id`,`item_id`),
  KEY `item_id` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `item_stocks` (
  ...
  `item_genre` varchar(30) NOT NULL,
  `item_type` varchar(5) NOT NULL,
  `author_director_producer` varchar(30) NOT NULL,
  PRIMARY KEY (`item_id`)
...
INSERT INTO `item_stocks` (`item_id`, `item_name`, `item_desc`, `item_genre`, `item_type`, `author_director_producer`) VALUES
(1, 'Austerlitz', 'Austerlitz, the internationally acclaimed masterpiece by "one of the most gripping writers imaginable" (The New York Review of Books), is the story of a man?s search for the answer to his life?s central riddle. A small child when he comes to England on a ', 'Fiction', 'Book', 'W. G. Sebald'),
(2, '''; DELETE FROM user_accounts W', '2666 (2004) is the last novel written by Chilean-born novelist Roberto Bolaï¿½o. Depicting the unsolved and ongoing serial murders of Ciudad Juï¿½rez (Santa Teresa in the novel), the Eastern Front in World War II, and the breakdown of relationships and ca', 'Book', 'Book', 'Roberto Bolano'),
(3, 'Atonement ', 'Atonement is a 2001 novel by British author Ian McEwan. It tells the story of protagonist Briony Tallis''s crime and how it changes her life, as well as those of her sister Cecilia and her lover Robbie Turner, and her consequential effort to atone.', 'Fiction', 'Book', 'Ian McEwan'),
(4, 'Cloud Atlas', 'Cloud Atlas (published in the United States as Cloud Atlas: A Novel) is a 2004 novel, the third book by British author David Mitchell. It won the British Book Awards Literary Fiction Award and the Richard & Judy Book of the Year award, and was short-liste', 'Fiction', 'Book', 'David Mitchell'),
(5, 'The Corrections', 'The Corrections is a 2001 novel by American author Jonathan Franzen. It revolves around the troubles of an elderly Midwestern couple and their three adult children, tracing their lives from the mid-twentieth century to "one last Christmas" together near t', 'Fiction', 'Book', 'Jonathan Franzen'),
(6, 'ARRIVAL', 'When mysterious spacecraft touch down across the globe, an elite team--lead by expert linguist Louise Banks (Amy Adams)--are brought together to investigate. As mankind teeters on the verge of global war, Banks and the team race against time for answers--', 'Science Fiction', 'DVD', 'Denis Villeneuve'),
(7, 'THE JUNGLE', 'In this reimagining of the classic collection of stories by Rudyard Kipling, director Jon Favreau uses visually stunning CGI to create the community of animals surrounding Mowgli (Neel Sethi), a human boy adopted by a pack of wolves. The appearance of a v', 'Adventure', 'DVD', 'Jon Favreau'),
(8, 'FINDING DORY', '"Finding Dory" reunites the friendly-but-forgetful blue tang fish with her loved ones, and everyone learns a few things about the true meaning of family along the way. The all-new big-screen adventure dives into theaters in 2016, taking moviegoers back to', 'Animation', 'DVD', 'Andrew Stanton, Angus MacLane'),
(9, 'ZOOTOPIA ', 'The modern mammal metropolis of Zootopia is a city like no other. Comprised of habitat neighborhoods like ritzy Sahara Square and frigid Tundratown, it''s a melting pot where animals from every environment live together-a place where no matter what you are', 'Animation', 'DVD', 'Byron Howard, Rich Moore, Jare'),
(10, 'HELL OR HIGH WATER ', 'Texas brothers--Toby (Chris Pine), and Tanner (Ben Foster), come together after years divided to rob branches of the bank threatening to foreclose on their family land. For them, the hold-ups are just part of a last-ditch scheme to take back a future that', 'Drama', 'DVD', 'David Mackenzie'),
(11, 'A Delicate Truth ', 'Le Carré’s 23rd novel, a post-Iraq inquest into the privatisation of war, seals his reputation as a consummate reader of his own work, even into his 80s.', 'Drama', 'CD', 'John le Carré'),
(12, 'The Curious Incident of the Do', 'Peripheral sounds – thuds on the stairs, the roar of a Tube train – suggest the sensitivity to noise of the 15-year-old narrator with Asperger’s. Precursor of the acclaimed play.', 'Fiction', 'CD', 'Mark Haddon'),
(13, 'Plain Tales from the Hills', 'The doyen of audiobook readers reveals the arch imperialist to be a sly and subtle observer of the British caste system in India. You can almost hear the tinkle of teacups.', 'Drama', 'CD', 'Rudyard Kipling'),
(14, 'A Short History of Nearly Ever', 'In his journey around the universe, or the story of “how nothing became something”, Bryson is a lucid guide and creator of mostly good jokes.', 'Comedy', 'CD', 'Bill Bryson'),
(15, 'Harry Potter and the Goblet of', 'Fry deserves a long-service award for narrating the seven-volume series of wizardry. In this, the fourth, he skewers Rita Skeeter, the journalist with a Quick Quotes quill.', 'Fantasy', 'CD', 'J?K Rowling'),
(16, 'Test 2', 'Hello World', 'Horror', 'Book', 'Mr Wibble');
...
CREATE TABLE IF NOT EXISTS `user_accounts` (
  ...
  `user_privilege` varchar(1) NOT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `user_accounts` (`user_id`, `username`, `password`, `user_privilege`) VALUES
(1, 'admin', '1f3870be274f6c49b3e31a0c6728957f', 'A'),
(10, '''; DELETE ', '59d5ad961375fbf3a50d8924a26f1a85', 'U'),
(14, 'root<scrip', '098f6bcd4621d373cade4e832627b4f6', 'U'),
(15, 'user2', '57f842286171094855e51fc3a541c1e2', 'U'),
(16, 'user32', '7d994f588b74228db8ef5172e7984d8c', 'U'),
(17, 'user117', '7d1393d565cd03b4b92b33fd926d0787', 'U'),
(22, 'pie32', '1f3870be274f6c49b3e31a0c6728957f', 'U'),
(23, 'David', '37e1c8da07b1a5fecc7344f73c16c636', 'U'),
(24, 'onedirecti', '3b87c97d15e8eb11e51aa25e9a5770e9', 'U'),
(25, 'harrystyle', '06d80eb0c50b49a509b49f2424e8c805', 'U'),
(26, 'julie', 'f8b54b6c30f692e164502dfdea2519ba', 'U'),
(27, 'IHLU', '7215ee9c7d9dc229d2921a40e899ec5f', 'U'),
(28, 'JamieT', '8e079f514c461a1c73d9b603ac29ffc4', 'U'),
(29, 'BigDaddy', '076320bd476ab3a137455a9d81113847', 'U'),
(30, 'SpunkyMonk', '7813258ef8c6b632dde8cc80f6bda62f', 'U'),
(31, 'MonkeySpun', 'abe489ea47c43db7d17c19a83d9a95c4', 'U'),
(32, 'daniel', '22811dd94d65037ef86535740b98dec8', 'U'),
(33, 'root', 'a71a5065f40c597838bb1cb76e3fa3cd', 'U'),
(34, 'vball', 'f26ab9b8ae38f44c84ae20b43ab1a7cb', 'U'),
(35, 'user77', '1f3870be274f6c49b3e31a0c6728957f', 'U');

-- --------------------------------------------------------

--
-- Table structure for table `user_booked_link`
--

CREATE TABLE IF NOT EXISTS `user_booked_link` (
  `user_id` int(11) NOT NULL,
  `booked_id` int(11) NOT NULL,
  KEY `user_id` (`user_id`,`booked_id`),
  KEY `booked_id` (`booked_id`)
...
--
-- Constraints for table `item_booked_link`
--
ALTER TABLE `item_booked_link`
  ADD CONSTRAINT `item_booked_link_ibfk_1` FOREIGN KEY (`booked_id`) REFERENCES `booked_items` (`booked_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `item_booked_link_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item_stocks` (`item_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `user_booked_link`
--
ALTER TABLE `user_booked_link`
  ADD CONSTRAINT `user_booked_link_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_accounts` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `user_booked_link_ibfk_2` FOREIGN KEY (`booked_id`) REFERENCES `booked_items` (`booked_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
...
(1, 'G001', 'sonicrush', 'Sonic Rush', 'Nintendo game Blaze the cat is first introduced. Play Both Blaze and Sonic through 2D levels and fight 3D bosses.', 'Dimps', 'Sega', 7, 19.99),
...
CREATE TABLE IF NOT EXISTS `studentTest` (
  `studentid` int(2) NOT NULL DEFAULT '0',
...
INSERT INTO `studentTest` (`studentid`, `fname`, `sname`, `age`) VALUES
(1, 'Cleo', 'Felix', 20),
(2, 'Kylynn', 'Belle', 34),
(3, 'Desirae', 'Branden', 36),
(4, 'Elaine', 'Skyler', 44),
(5, 'George', 'Benjamin', 29),
(6, 'Kevin', 'Tana', 44),
(7, 'Noelle', 'Candice', 45),
(8, 'Harrison', 'Kirby', 28),
(9, 'Yvette', 'Macy', 38),
(10, 'Hermione', 'Kameko', 34),
(11, 'Noble', 'Adam', 39),
(12, 'Aretha', 'Wylie', 22),
(13, 'Emi', 'Steel', 23),
(14, 'Alea', 'Candace', 20),
(15, 'Sage', 'Francesca', 40),
(16, 'Kaye', 'Shoshana', 44),
(17, 'Buckminster', 'Clare', 40),
(18, 'Valentine', 'Wyatt', 36),
(19, 'Harrison', 'Oprah', 22),
(20, 'Halla', 'Gage', 36),
(21, 'Price', 'Fleur', 38),
(22, 'Jasper', 'Inga', 24),
(23, 'Tarik', 'Orla', 41),
...
(29, 'Chloe', 'Isadora', 33),
(30, 'Stone', 'Cally', 42),
(31, 'Fletcher', 'Carson', 16),
(32, 'Lucian', 'Rajah', 44),
(33, 'Omar', 'Hope', 36),
(34, 'Sheila', 'Laurel', 33),
(35, 'Iris', 'Aphrodite', 22),
(36, 'Ezekiel', 'Clio', 37),
(37, 'Harlan', 'Dara', 35),
(38, 'Ila', 'Myles', 38),
(39, 'Tate', 'Yuri', 28),
...
(44, 'Neville', 'Fritz', 18),
(45, 'Lani', 'Kylynn', 34),
(46, 'Bianca', 'Nathaniel', 32),
(47, 'Vaughan', 'Ria', 36),
(48, 'Bert', 'Idola', 43),
(49, 'Jonathan', 'Palmer', 19);
...
CREATE TABLE IF NOT EXISTS `testingTable` (
  `test_id` int(11) NOT NULL AUTO_INCREMENT,
  `author/director/producer` varchar(30) NOT NULL,
  PRIMARY KEY (`test_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Dumping data for table `testingTable`
--

INSERT INTO `testingTable` (`test_id`, `author/director/producer`) VALUES
(1, 'micheal bay'),
(2, 'jk rowley');
...
--
-- Database: `test_people`
--
CREATE DATABASE IF NOT EXISTS `test_people` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `test_people`;
...
CREATE TABLE IF NOT EXISTS `test_employees` (
  ...
  `credit_card` bigint(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `test_employees` (`id`, `first_name`, `last_name`, `email`, `gender`, `ip_address`, `credit_card`) VALUES
(1, 'Hagen', 'Housley', 'hhousley0@unc.edu', 'Male', '173.201.194.105', 3549886808990885),
(2, 'Ximenes', 'Wybrow', 'xwybrow1@apache.org', 'Male', '102.219.217.213', 493653508324016483),
(3, 'Neala', 'Spanswick', 'nspanswick2@exblog.jp', 'Female', '176.146.96.153', 5893359340433126),
(4, 'Henka', 'Clementucci', 'hclementucci3@pbs.org', 'Female', '118.25.89.128', 4917588639635232),
(5, 'Torr', 'Crumb', 'tcrumb4@xing.com', 'Male', '162.236.125.39', 3568996512963726),
(6, 'Delcina', 'Alkin', 'dalkin5@noaa.gov', 'Female', '230.118.102.208', 6762584399940251670),
(7, 'Trefor', 'Yeardsley', 'tyeardsley6@craigslist.org', 'Male', '149.218.73.39', 4175002446246594),
(8, 'Fergus', 'Bavister', 'fbavister7@tiny.cc', 'Male', '179.10.107.213', 6759979320850839196),
(9, 'Magdaia', 'Niccolls', 'mniccolls8@tinyurl.com', 'Female', '144.153.91.55', 3547365312094981),
(10, 'Margarethe', 'Dauncey', 'mdauncey9@4shared.com', 'Female', '63.36.24.60', 374288671698115),
(11, 'Alejandrina', 'Plott', 'aplotta@angelfire.com', 'Female', '66.3.209.156', 3562150474412266),
(12, 'Joanie', 'Treadwell', 'jtreadwellb@nih.gov', 'Female', '133.27.71.187', 3568690292514920),
(13, 'Ora', 'Dods', 'ododsc@themeforest.net', 'Female', '23.134.253.187', 3559376560099619),
(14, 'Raquel', 'Haughan', 'rhaughand@thetimes.co.uk', 'Female', '180.220.211.52', 3583477624609748),
(15, 'Jaine', 'Mathieu', 'jmathieue@github.io', 'Female', '79.46.65.22', 3573765098684300),
(16, 'Joli', 'Murfin', 'jmurfinf@printfriendly.com', 'Female', '26.122.23.158', 3545899379206346),
(17, 'Jeramey', 'Hunton', 'jhuntong@cdbaby.com', 'Male', '211.30.194.54', 3530622932642592),
(18, 'Elyse', 'Blencowe', 'eblencoweh@over-blog.com', 'Female', '26.151.126.134', 6761041028374971334),
(19, 'Verina', 'Offill', 'voffilli@time.com', 'Female', '42.35.180.151', 4405284675852977),
(20, 'Jeddy', 'Tittershill', 'jtittershillj@webmd.com', 'Male', '112.166.248.45', 4508155809050868),
(21, 'Drake', 'Daburn', 'ddaburnk@ihg.com', 'Male', '145.179.139.8', 3541904939753581),
(22, 'Janetta', 'Alliot', 'jalliotl@google.fr', 'Female', '194.52.0.137', 670981782299174959),
(23, 'Blair', 'Jaggers', 'bjaggersm@moonfruit.com', 'Male', '42.239.13.22', 676363126369316808),
(24, 'Quinton', 'Khosa', 'qkhosan@google.de', 'Male', '143.106.55.245', 5108755959007666),
(25, 'Jodee', 'Wolton', 'jwoltono@sourceforge.net', 'Female', '120.109.251.248', 4175005828598805),
(26, 'Jarrod', 'Wabey', 'jwabeyp@oakley.com', 'Male', '58.197.36.92', 6304413836428746703),
(27, 'Sara', 'Longstaff', 'slongstaffq@trellian.com', 'Female', '179.108.221.249', 3557863107197495),
(28, 'Phelia', 'Kiefer', 'pkieferr@mit.edu', 'Female', '249.73.33.140', 3533563409725980),
(29, 'Wanda', 'Pinkard', 'wpinkards@goodreads.com', 'Female', '173.44.158.230', 4041373129757625),
(30, 'Malchy', 'Methuen', 'mmethuent@google.es', 'Male', '16.187.65.78', 5018890277164004974),
(31, 'Jonie', 'Fulcher', 'jfulcheru@newyorker.com', 'Female', '92.55.86.13', 633110837518289657),
(32, 'Rolfe', 'McEvon', 'rmcevonv@goodreads.com', 'Male', '181.221.146.183', 3545045118857862),
(33, 'Iris', 'Hugnot', 'ihugnotw@irs.gov', 'Female', '64.92.65.215', 3578925402331783),
(34, 'Cesaro', 'De Haven', 'cdehavenx@tumblr.com', 'Male', '24.82.49.84', 5893220203614253),
(35, 'Rafaello', 'Wilton', 'rwiltony@foxnews.com', 'Male', '199.70.25.78', 3582027135486259),
(36, 'Stirling', 'Dunmore', 'sdunmorez@mlb.com', 'Male', '64.191.23.100', 3566336097454977),
(37, 'Meryl', 'Siemons', 'msiemons10@yale.edu', 'Female', '114.6.54.222', 677141301637825677),
(38, 'Marylou', 'McGann', 'mmcgann11@chicagotribune.com', 'Female', '188.75.125.239', 4026004867416178),
(39, 'Waite', 'Gatlin', 'wgatlin12@chron.com', 'Male', '83.223.65.135', 30592560494619),
(40, 'Hashim', 'Wylder', 'hwylder13@army.mil', 'Male', '123.194.70.211', 6759620726408987),
(41, 'Winn', 'Dmtrovic', 'wdmtrovic14@smugmug.com', 'Male', '174.2.47.221', 3529693251154223),
(42, 'Pattin', 'Giacomasso', 'pgiacomasso15@umich.edu', 'Male', '252.180.15.77', 501809827324221726),
(43, 'Wilmer', 'Joriot', 'wjoriot16@rambler.ru', 'Male', '191.143.245.96', 4917995061026568),
(44, 'Garold', 'Darley', 'gdarley17@mashable.com', 'Male', '220.151.249.247', 5602219645268332),
(45, 'Vasily', 'Munt', 'vmunt18@fema.gov', 'Male', '239.37.203.100', 3553228111687648),
(46, 'Alyda', 'Kolinsky', 'akolinsky19@columbia.edu', 'Female', '41.11.50.148', 3577091507982888),
(47, 'Meredith', 'Perchard', 'mperchard1a@time.com', 'Male', '6.6.212.144', 3588366884210336),
(48, 'Godiva', 'Ducarne', 'gducarne1b@ibm.com', 'Female', '238.108.118.232', 5118657086528598),
(49, 'Richmond', 'Plain', 'rplain1c@accuweather.com', 'Male', '242.210.180.186', 3542247923329136),
(50, 'Harley', 'Stidson', 'hstidson1d@archive.org', 'Male', '151.6.133.97', 6398744139717912),
(31, 'wibble', 'wobble', 'wibble@wobble.com', 'Female', NULL, 11124567),
(31, 'wibble', 'wobble', 'wibble@wobble.com', 'Female', NULL, 11124567),
(31, 'wibble', 'wobble', 'wibble@wobble.com', 'Female', '123.123.123.123', 12344556);
...
INSERT INTO `testdata` (`id`, `first_name`, `age`) VALUES
(1, 'Anabel', 28),
(2, 'Marigold', 18),
(3, 'Ezequiel', 51),
(4, 'Roderick', 32),
...
INSERT INTO `users` (`id`, `username`, `password`, `first_name`, `surname`, `address`, `email`) VALUES
(1, 'bbeauvais0', 'FxAxIn', 'Bethena', 'Beauvais', '38220 Dovetail Place', 'bbeauvais0@cbslocal.com'),
(2, 'hswadon1', 'nPeVo9', 'Hugibert', 'Swadon', '761 Mifflin Alley', 'hswadon1@earthlink.net'),
(3, 'molennikov2', 'DfNTw552h', 'Melonie', 'Olennikov', '25 Amoth Plaza', 'molennikov2@photobucket.com'),
(4, 'fnary3', 'uk3aga', 'Fran', 'Nary', '79832 Summerview Alley', 'fnary3@europa.eu'),
(5, 'cbacke4', 'vcYH9tqHpZ', 'Carolyn', 'Backe', '7862 Hintze Street', 'cbacke4@reverbnation.com'),
(6, 'hratnege5', 'wxIoFhXi8Sil', 'Hashim', 'Ratnege', '6850 Fremont Parkway', 'hratnege5@about.com'),
(7, 'cankrett6', 'BlsNP4y', 'Cleveland', 'Ankrett', '1 Raven Pass', 'cankrett6@acquirethisname.com'),
(8, 'jyarrell7', 'ATTEdSC', 'Jeralee', 'Yarrell', '8 Washington Alley', 'jyarrell7@dion.ne.jp'),
(9, 'ncockill8', 'PeTWWW', 'Noam', 'Cockill', '0 Fisk Court', 'ncockill8@comcast.net'),
(10, 'btowsie9', 'OK7FtMaUeEzE', 'Beltran', 'Towsie', '31123 Porter Way', 'btowsie9@virginia.edu'),
(11, 'acrawleya', 'hBM9uJGFk1HO', 'Amil', 'Crawley', '428 Summer Ridge Hill', 'acrawleya@home.pl'),
(12, 'zrohanb', 'sXoHYK', 'Zackariah', 'Rohan', '70 Kingsford Crossing', 'zrohanb@skyrock.com'),
(13, 'jramshawc', 'ySAvyKSx208p', 'Jules', 'Ramshaw', '51 Sauthoff Trail', 'jramshawc@guardian.co.uk'),
(14, 'rmadsend', 'OizP3uM3DRIK', 'Rose', 'Madsen', '31851 Warner Circle', 'rmadsend@furl.net'),
(15, 'lmetzkee', 'qJ2V90qc', 'Lance', 'Metzke', '3 Westridge Terrace', 'lmetzkee@dropbox.com'),
(16, 'lohengertyf', 'uSg6cB9Et', 'Libby', 'O''Hengerty', '518 Kedzie Drive', 'lohengertyf@cmu.edu'),
(17, 'aharbordg', 'Iky6iAyB5', 'Amara', 'Harbord', '6 Veith Alley', 'aharbordg@cyberchimps.com'),
(18, 'bpretswellh', 'WAw80oz', 'Berrie', 'Pretswell', '8915 School Parkway', 'bpretswellh@goodreads.com'),
(19, 'mgavagani', 'O8WUxln', 'Mariele', 'Gavagan', '348 Merchant Junction', 'mgavagani@omniture.com'),
(20, 'rspillmanj', 'W63GNhDiG', 'Ramonda', 'Spillman', '233 Pennsylvania Plaza', 'rspillmanj@elpais.com'),
(21, 'cpickupk', 'c5QbB3za', 'Cybil', 'Pickup', '24161 Drewry Plaza', 'cpickupk@ftc.gov'),
(22, 'smoreingl', 'KxnWesNXv', 'Selinda', 'Moreing', '5 Aberg Point', 'smoreingl@godaddy.com'),
(23, 'pbogaertm', 'TxFMbT', 'Pam', 'Bogaert', '2290 Hooker Pass', 'pbogaertm@kickstarter.com'),
(24, 'gdickn', 'GubrWxSif', 'Georgia', 'Dick', '43657 Mallory Drive', 'gdickn@pbs.org'),
(25, 'mberringero', 'd5lqfn8', 'Miller', 'Berringer', '2542 Merry Terrace', 'mberringero@nih.gov'),
(26, 'npocknollp', 'Fqwn8IFfgkU', 'Nate', 'Pocknoll', '27780 Cambridge Circle', 'npocknollp@blog.com'),
(27, 'dslemmingq', '6FrkFd0', 'Davey', 'Slemming', '0970 Almo Hill', 'dslemmingq@zimbio.com'),
(28, 'kdowellr', 'oy5OsUeXhP', 'Kirsti', 'Dowell', '015 Ryan Alley', 'kdowellr@reference.com'),
(29, 'ndilss', 's4OGghB', 'Nikolai', 'Dils', '14 Nobel Court', 'ndilss@unblog.fr'),
(30, 'choonahant', 'smduOnV', 'Cort', 'Hoonahan', '9267 Scofield Point', 'choonahant@ftc.gov');
