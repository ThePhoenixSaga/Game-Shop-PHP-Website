...
<div class="gridContainer clearfix">
  ...
  <!--Body-->
  <div id="body">
    <h2>Welcome to Palmer Gaming, home of mixed eras of games from moderns to classics.</h2>
    <img id="body" src="/assignment1_website/images/pageImages/home.jpg" alt="collection of games" style="	clear: both;
	float: left;" >
    <p id="body">Buy our selection of games at reasonable prices, we aim to beat the leading competiters markup so you can get the best deals.<p/>
  </div>
