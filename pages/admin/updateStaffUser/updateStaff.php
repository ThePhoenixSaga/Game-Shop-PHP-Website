...
<title>Staff account updated</title>
...
<div class="gridContainer clearfix">
  ...
  <div id="body">
   ...
   try
   {
        ...
        $SQL = "UPDATE users SET username= :Username, first_name= :First_Name, last_name= :Last_Name, email= :Email, address= :Address, access_level= :Access_Level WHERE username= :Username";
        ...
        $Query -> bindParam(':Access_Level', $AccessLevel);

        $Query->execute();

        if($Query)
        {
          header("Location: updateStaffThank.php");
        } else {
