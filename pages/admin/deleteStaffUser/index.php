...
<title>Deleting staff user account</title>
...
<div class="gridContainer clearfix">
  ...
  <div id="header">
    <h1>
     Please confirm if you wish to delete user account
    </h1>
  </div>
  ...
  <div id="body">
   ...
   try{
      ...
      if($result)
      {
      echo "<form name=\"deleteStaff\" action=\"deleteUser.php\" method=\"POST\">";
      foreach ($result as $row)
      {
        ...
        echo "<input type=\"text\" name=\"Access_Level\" value=\"".$row['access_level']."\" readonly/>";
        
      }
        echo "<input type=\"submit\" name=\"submit\" value=\"Delete staff user\">";
      echo "</form>";
