...
<!doctype html>
      ...
      * you can also remove the link to respond.min.js if you included the MQ Polyfill in your modernizr build 
      ...
      <div class="gridContainer clearfix">
        ...
        <!--Body-->
        <div id="body">
          <p>Sorry, there has been a problem with creating your account, please try again later and check you have entered the account details correctly.</p>  
          <p>Try a different username, in case someone already has it.</p>
        </div>
