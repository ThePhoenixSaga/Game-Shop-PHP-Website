...
<title>Product Order Error</title>
...
<div class="gridContainer clearfix">
  ...
  <!--Body-->
  <div id="body">
    <p>An error has occured processing your order. If you are not logged in, please make sure you log in. If you are and you still got this message, please try again later. Contact web administrator for further assisstance.</p>
    <p>Check the products page stock for the desired product to see if it is still in stock.</p>
  </div>
